...
export class LoginPage {
  ...
  ionViewDidLoad() { 
      ...
      this.accountData.getLang().then((lang) => {
       ...
       //Desktop Testing
      // this.accounts = [{account: 'ONZfmqwdNr6yxy4cZDkWc71oWyuUDnRJcEsd' , name: 'tool_462', password: ''},{account: 'ONZfmqwdNr6yxy4cZDkWc71oWyuUDnRJcEsd' , name: 'tool_462', password: ''},{account: 'ONZfmqwdNr6yxy4cZDkWc71oWyuUDnRJcEsd' , name: 'tool_462', password: ''}];
